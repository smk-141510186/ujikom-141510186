	...
	<form method="POST" action="{{route('tunjangan.update',$tunjangan->id)}}">
		...
		<div class="form-group{{ $errors->has('kode_tunjangan') ? ' has-error' : '' }}">
			...
			<div class="form-group col-md-8">
				<input class="form-control" type="text" name="kode_tunjangan" value="{{$tunjangan->kode_tunjangan}}" autofocus>
		...
		<div class="form-group{{ $errors->has('jumlah_anak') ? ' has-error' : '' }}">
			...
			<div class="form-group col-md-8">
				<input class="form-control" type="text" name="jumlah_anak" value="{{$tunjangan->jumlah_anak}}" autofocus>
		...
		<div class="form-group{{ $errors->has('besaran_uang') ? ' has-error' : '' }}">
			...
			<div class="form-group col-md-8">
				<input class="form-control" type="text" name="besaran_uang" value="{{$tunjangan->besaran_uang}}" autofocus>
