...
<div class="container">
	<div class="panel panel-info">
		...
		<a class="btn btn-success" href="{{url('lembur-pegawai/create')}}">
			<b>
			...
			<table class="table table-striped table-bordered table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a class="btn btn-info btn-sm" href="{{route('lembur-pegawai.edit', $data->id)}}"><span class="glyphicon glyphicon-edit"></span>Ubah</a>
						</td>
						<td>
